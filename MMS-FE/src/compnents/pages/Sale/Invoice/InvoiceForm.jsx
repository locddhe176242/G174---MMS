            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  />
                  {errors.invoiceDate && (
                    <p className="text-sm text-red-600 mt-1">{errors.invoiceDate}</p>
                  )}
                </div>

                <div>
                  <label className="block text-sm text-gray-600 mb-1">Ngày đến hạn thanh toán</label>
                  <DatePicker
                    ...
                    {selectedDelivery.items
                      ...
                      .map((item, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-4 py-3 text-left">{item.uom || "—"}</td>
                        </tr>
                      ))}
                  </tbody>
                </table>
                <p className="px-6 py-3 text-sm text-gray-600 border-t border-gray-200">
