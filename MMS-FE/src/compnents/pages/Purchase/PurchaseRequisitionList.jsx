                                            ...
                                            <tr key={reqId} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div className="flex items-center gap-1">
                                                        <button
                                                            onClick={() => navigate(`/purchase/purchase-requisitions/${reqId}`)}
                                                        ...
                                                        {getStatusString(requisition.status || requisition.approvalStatus) === 'Draft' && (
                                                            <button
                                                                onClick={() => navigate(`/purchase/purchase-requisitions/${reqId}/edit`)}
                                                        ...
                                                        {/* Chỉ hiển thị nút delete khi chưa submit (Draft) */}
                                                        {getStatusString(requisition.status || requisition.approvalStatus) === 'Draft' && (
                                                            <button onClick={() => handleDeleteClick(requisition)}
                                                                    className="group p-2.5 rounded-lg bg-red-50 hover:bg-red-100 text-red-600 hover:text-red-700 transition-all duration-200 hover:scale-105 hover:shadow-md border border-red-200 hover:border-red-300" title="Xóa">
                                                                <svg className="w-4 h-4 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4">
                        ...
                        <h2 className="text-lg font-medium text-gray-900 mb-4 text-center">Xác nhận xóa phiếu yêu
                            cầu?</h2>
