                        ...
                        <div className="flex items-center gap-1">
                            ...
                            {rfqId && (
                                <button
                                    ...
                                    className="px-3 py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-700 hover:text-gray-800 rounded-md border border-gray-200 hover:border-gray-300 transition-all duration-200 flex items-center gap-1.5 text-xs font-medium"
                                    title="Xem RFQ"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
