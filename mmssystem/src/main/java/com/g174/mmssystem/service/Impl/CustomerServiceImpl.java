...
public class CustomerServiceImpl implements ICustomerService {
    ...
    public CustomerResponseDTO updateCustomer(Integer customerId, CustomerRequestDTO customerRequestDTO) {
        ...
        // Check duplicate nếu customerCode có thay đổi
        if (customerRequestDTO.getCustomerCode() != null &&
                !customer.getCustomerCode().equals(customerRequestDTO.getCustomerCode()) &&
        ...
        customer.setFirstName(customerRequestDTO.getFirstName());
        customer.setLastName(customerRequestDTO.getLastName());
        // Chỉ set customerCode nếu có giá trị
        if (customerRequestDTO.getCustomerCode() != null && !customerRequestDTO.getCustomerCode().trim().isEmpty()) {
            customer.setCustomerCode(customerRequestDTO.getCustomerCode());
        }
        customer.setNote(customerRequestDTO.getNote());
