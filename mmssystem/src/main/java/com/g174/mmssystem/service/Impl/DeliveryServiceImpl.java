...
public class DeliveryServiceImpl implements IDeliveryService {
    ...
    private List<DeliveryItem> buildItems(Delivery delivery, List<DeliveryItemRequestDTO> requestItems, SalesOrder salesOrder) {
        ...
        for (DeliveryItemRequestDTO dto : requestItems) {
            ...
            BigDecimal alreadyPlannedQty = deliveryItemRepository.sumPlannedQtyBySalesOrderItem(salesOrderItem.getSoiId());
            BigDecimal maxPlannedQty = orderedQty.subtract(alreadyPlannedQty);
